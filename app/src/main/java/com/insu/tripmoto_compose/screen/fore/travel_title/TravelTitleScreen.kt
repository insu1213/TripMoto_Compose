package com.insu.tripmoto_compose.screen.fore.travel_title
...
fun TravelTitleScreen(
    ...
    Column() {
        Column(
            ...
            MenuTitleText(modifier = Modifier.padding(top = 44.dp), text = R.string.travel_title)
        ...
        Column(
            ...
            BasicButton(
                ...
                viewModel.titleOnNextClick(openAndPopUp)
            }
        }
    }
}